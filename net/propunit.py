...
class PropUnitCell(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, bias):
        ...
        self.resblock, _ = make_resblock(self.input_dim, 32, blocks=2, stride=1, block=Bottleneck)

        self.conv = nn.Conv2d(in_channels=32 * Bottleneck.expansion + self.hidden_dim,
